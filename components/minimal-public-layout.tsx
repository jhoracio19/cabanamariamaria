...
// Layout minimalista compartido por páginas públicas de un solo propósito
// (invitaciones digitales, formulario de reseñas) que no necesitan el
// header/footer completo del sitio de marketing.
